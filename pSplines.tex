...
Alternatively to the Metropolis step used for \bm{v}, a data augmentation step based on Polya-Gamma auxiliary variables can be used which would allow for a full Gibbs sampler \citep{Polson:2013}. 
