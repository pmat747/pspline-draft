...
\textcolor{red}{Since the weights in general are larger in those areas of the frequency domain where the psd has peaks, we specify their starting value proportionally to the periodogram. Applying the corresponding transformation we obtain the starting value for the vector $\bm{v}$.  This strategy speeds up the MCMC process by shorting the burn-in period.}
