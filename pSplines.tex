...
\begin{enumerate}
	...
	\item The Q-spaced internal knot vector is given by the corresponding quantiles $\bm{\xi}^* = \left(\widetilde{F}^{-1}(q_1),\dots, \widetilde{F}^{-1}(q_{K^*}) \right)$. %where the inverse function is obtained by interpolation.	
\end{enumerate}
