...
The P-spline analysis was performed using the \texttt{gibbs\_pspline} function implemented in the \textsf{R} package \texttt{psplinePsd} \cite{psplinepackage}.  A total of 100,000 MCMC samples were generated
